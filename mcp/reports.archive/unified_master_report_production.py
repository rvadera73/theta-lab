...
# ═══════════════════════════════════════════════════════════════════
# PRODUCTION FRAMEWORK — 60% CLOSE COST RATIO (SUPPLEMENTARY)
# ═══════════════════════════════════════════════════════════════════
CLOSE_COST_RATIO = 0.60
MONTHLY_TARGET_NET_BASE = 100000
MONTHLY_TARGET_GROSS_BASE = int(MONTHLY_TARGET_NET_BASE / (1 - CLOSE_COST_RATIO))
...
ACCOUNT_TARGETS = {
    'Account A (232)': {'gross': 156000, 'net': 62400},
    'Account B (275)': {'gross': 4900, 'net': 1960},
    'Account C (634)': {'gross': 4100, 'net': 1640},
    'Fidelity (Rahul)': {'gross': 7850, 'net': 3140},
    'Fidelity (Rajul — Roth IRA)': {'gross': 675, 'net': 270},
    'Fidelity (Rajul — Rollover IRA)': {'gross': 2025, 'net': 810},
    'Vanguard (Rahul)': {'gross': 5125, 'net': 2050},
    'Robinhood (Individual)': {'gross': 200, 'net': 80},
    'Robinhood (Traditional IRA)': {'gross': 3350, 'net': 1340},
}
